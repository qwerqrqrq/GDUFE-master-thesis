...
\begin{figure}[htbp]
    ...
    \begin{subfigure}{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/colorful.jpg}
        \caption{First}
        \label{fig:a}
    \end{subfigure}
...
\begin{figure}[!ht]
    \centering
    \begin{subcaptionblock}{0.9\textwidth}{
            \includegraphics[width=\textwidth]{figures/colorful.jpg}
            \caption{$\beta=0.9$}
            \label{fig2-a}
        }\end{subcaptionblock}\\
    ...
    \caption{当 $c=1, k_1=-2, k_2 = -1, \lambda=3, \mu=2, \delta=0, \sigma_1 = 1, \sigma_2 = 1$时, $|u_{1,1}|$ 的波形图}
    \label{fig:2}
\end{figure}
...
\[ H = \frac{\alpha_2}{2} v^2 + \frac{\alpha_3}{4} v^4 - \frac{1}{2} w^2 \]

times new roman : 1234567890

$times new roman : 1234567890 \d$

$u = \frac{c k \,r^{2}+a r-s}{2 b r}+\frac{c r \,k {\mathrm e}^{k z} A_{1}}{b \left({\mathrm e}^{k z} A_{1}+l\right)}$
...
% 正文：这篇文章，使用了宋体和 Times New Roman 字体。下面是一些字体命令的效果对比。\the\baselineskip  \the\parskip
...
% % \end{verbatim}
% % text text
% % \begin{lstlisting}[language=TeX, label={lst:tikz_example}]
% % \begin{tikzpicture}[xshift=0.5cm]
% %     \draw[draw=yellow!15,fill=yellow!15](-1.8,-1.8)rectangle(2,1.8);
% %     \draw[help lines, step=0.5cm](-1.48,-1.48)grid(1.48,1.48);
% %     \draw[->,thick] (-1.5,0)--(1.5,0)node[right=1pt]{$x$};
...
% \cite{huangzh,r1,r2,r3,r4,r5,anon-cn1,anon-cn1,anon-cn2,anon-cn3,anon-cn4,anon-cn5,anon-en1,anon-en2,anon-en3,anon-en4,anon-en5}
